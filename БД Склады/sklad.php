...
$result=mysql_query("SELECT * FROM `sclad` WHERE 1");
echo "<table border=1px>";
echo"<tr><th>Номер</th>
<th>Название</th>
<th>Владелец</th>
<th>Вместимость</th>
<th>Срок хранения</th><td><a href=Add.php>Добавить</a></td><td><a href=del.php>Удалить</a></td><td><a href=Read.php>Проверить</a></td></tr>";
